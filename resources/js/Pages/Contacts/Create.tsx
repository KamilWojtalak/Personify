...
export default function Create() {
    const { availablePersonas } = usePage<Props>().props;
    ...
    return (
        <>
            ...
            <DefaultLayout>
                <div className="mb-8">
                    <h1 className="mb-2 text-3xl font-bold text-gray-900">Create Contact</h1>
                    <p className="text-gray-600">Define a new contact with optional details</p>
                </div>
